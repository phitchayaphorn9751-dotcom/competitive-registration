...
const T = {
  ...
  "myreg.tabWaitlist": { th: "คิวสำรอง", en: "Waitlist" },
  "myreg.tabCancelled": { th: "ยกเลิก", en: "Cancelled" },
  ...
  "reg.waitlistTitle": { th: "จำนวนเต็มแล้ว — คุณเป็นคิวสำรอง", en: "Course full — you're on the waitlist" },
  "reg.waitlistMsg": { th: "เมื่อมีที่ว่างระบบจะเรียกคิวอัตโนมัติตามลำดับ ดูสถานะได้ที่หน้าการสมัครของฉัน", en: "When a seat opens, we'll call the next in line automatically. Check status in My Registration." },
